...
INSERT INTO chucvu VALUES(N'IT',N'Lập trình viên',0.25);
...
INSERT INTO chucvu VALUES (N'SDS' , N'SS', 0.3)
select * from nhanvien WHERE manv = N'nv001';
select * from quatrinhluong;
select *from chucvu
select  nv.* , cv.tencv from nhanvien nv , chucvu cv where nv.macv= cv.macv