...
--Cho biết các nhân viên có mã chức vụ là = 'CV'
SELECT * from nhanvien where macv = 'CV';
--Cho biết nhân viên có tên chứa kí tự = 't'
SELECT * from nhanvien where tennv like 't%';
--O--Cho biết các nhân viên đã được nâng lương trên 3 lần
...
where nhanvien.manv = sau.manv and sau.ngaybd > trc.ngaybd and sau.manv = trc.manv and sau.hsluong > trc.hsluong
